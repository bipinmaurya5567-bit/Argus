...
COPILOT_USER_AGENT = os.environ.get(
    "ARGUS_COPILOT_USER_AGENT", "Argus/1.0"
)
COPILOT_INTEGRATION_ID = os.environ.get(
    "ARGUS_COPILOT_INTEGRATION_ID", "vscode-chat"
)
COPILOT_EDITOR_VERSION = os.environ.get(
    "ARGUS_COPILOT_EDITOR_VERSION", "Argus/1.0"
)
