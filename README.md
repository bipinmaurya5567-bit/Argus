...
<p align="center">
  <a href="https://repology.org/project/argus-ai/versions"><img src="https://repology.org/badge/vertical-allrepos/argus-ai.svg" alt="Packaging status"></a>
</p>
...
Open `http://localhost:7000` when the containers are healthy. The first admin password is printed in `docker compose logs argus`.
...
Argus is a self-hosted workspace with powerful local tools. Keep auth enabled, keep private data out of Git, and do not expose raw model/service ports publicly. Deployment details are in the [setup guide](docs/setup.md#security-notes).
