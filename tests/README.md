...
```text
[order-report] working directory: /path/to/argus
...
[order-report] reproduce with: /path/to/argus/venv/bin/python /path/to/argus/tests/run_order_report.py --seed 284734921 -- tests/cli/ -q
```
