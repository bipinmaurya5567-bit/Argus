"""`argus-research list --status complete` was returning nothing.
...
Part of #2122 (argus-* CLI list/search bugs).
"""
...
def _load_cli():
    path = ROOT / "scripts" / "argus-research"
    loader = importlib.machinery.SourceFileLoader("argus_research_cli", str(path))
