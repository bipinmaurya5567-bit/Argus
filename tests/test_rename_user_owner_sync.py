...
def test_rename_research_respects_custom_data_dir(monkeypatch, tmp_path):
    """DEEP_RESEARCH_DIR (which honours ARGUS_DATA_DIR) is used, not a
    hardcoded relative path. Before the fix, setting ARGUS_DATA_DIR made
