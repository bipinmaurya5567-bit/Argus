...
function initMermaid() {
  if (!window.mermaid || window.__argusMermaidReady) return;
  window.mermaid.initialize({ startOnLoad: false, theme: 'dark', securityLevel: 'loose' });
  window.__argusMermaidReady = true;
}
window.argusInitMermaid = initMermaid;
initMermaid();
...
const THINK_EXPANDED_KEY = 'argus-thinking-expanded';
