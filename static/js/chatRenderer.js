...
const _ACTION_RECENTS_KEY = 'argus-msg-actions-recent';
 ...
 */
const _USER_ACTION_RECENTS_KEY = 'argus-user-actions-recent';
...
export function addMessage(role, content, modelName, metadata) {
  try {
    ...
    var _roleText = role === 'user' ? 'You' : (isSlash || isCompacted) ? 'Argus' : modelRouteLabel(replyModels.requestedModel, resolvedModel);
