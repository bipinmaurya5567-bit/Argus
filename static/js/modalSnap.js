...
const EMAIL_DOC_SPLIT_WIDTH_KEY = 'argus-email-doc-split-width';
const EDGE_DOCK_WIDTH_KEY_PREFIX = 'argus-edge-dock-width';
...
(function _initEdgeDockResizeHandles() {
  ...
  window.addEventListener('argus:modal-opened', _positionEdgeDockResizeHandles);
  _positionEdgeDockResizeHandles();
})();
