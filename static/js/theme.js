...
const LS_KEY = 'argus-theme';
const CUSTOM_THEMES_KEY = 'argus-custom-themes';
...
const ADV_KEYS = [
  ...
  { key: 'brandColor',         css: '--brand-color',       label: 'Argus Logo',    group: 'Sidebar' },
...
export function initThemeUI() {
  ...
  if (exportBtnEl) {
    ...
    newExp.addEventListener('click', () => {
      ...
      a.href = url;
      a.download = 'argus_' + (obj.name || 'theme') + '.json';
      a.click();
