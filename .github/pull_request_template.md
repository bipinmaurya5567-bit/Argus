...
- [ ] I searched [open issues](https://github.com/pewdiepie-archdaemon/argus/issues) and [open PRs](https://github.com/pewdiepie-archdaemon/argus/pulls) — this is not a duplicate.
- [ ] This PR targets `dev`
...
- [ ] **Style match**: the change uses Argus's existing visual language. Specifically:
