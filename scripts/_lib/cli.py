"""scripts/_lib/cli.py — shared scaffolding for the `argus-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("argus-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/argus-foo`
...
VERSION = "0.1.0"  # bumped centrally; every argus-* CLI reports this
