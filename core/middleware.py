...
INTERNAL_TOOL_TOKEN = os.environ.get("ARGUS_INTERNAL_TOKEN") or secrets.token_hex(32)
INTERNAL_TOOL_HEADER = "X-Argus-Internal-Token"
...
def require_admin(request: Request):
    ...
    # (a) header-direct (caller set X-Argus-Internal-Token), or
